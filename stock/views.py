...
def update_available_stock(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # add product to Logs
            stock = Products_Logs(product_name=product_name, shop=request.user, sizes = product_sizes_json, colours=product_colours_json,amount = Total_amount,order_amount=Total_amount, product_variation = product_data_json )
